// invite button
const addGuestButton = document.querySelector(
  ".invite"
);
...
const guestFull = document.querySelector(
  ".alert"
);
// ? selects elements that appear when guest list is full
...
const updateGuestCount = function () {
  const guests = document.querySelectorAll(
    ".guest-list li"
  );
